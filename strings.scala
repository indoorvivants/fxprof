...
sealed abstract class UserTimingMarkerPayload_EntryType(value: String)
...
case object LongTaskMarkerPayload_Type
    extends StringLiteral("MainThreadLongTask")
...
sealed abstract class IPCMarkerPayload_Side(value: String)
    extends StringLiteral(value)
...
sealed abstract class IPCMarkerPayload_Direction(value: String)
    extends StringLiteral(value)
...
sealed abstract class IPCMarkerPayload_Phase(value: String)
    extends StringLiteral(value)
...
case object BrowsertimeMarkerPayload_Type
    extends StringLiteral("VisualMetricProgress")
...
sealed abstract class PausedRange_Reason(value: String)
    extends StringLiteral(value)
...
case object UnbalancedNativeAllocationsTable_WeightType
    extends StringLiteral("bytes")
