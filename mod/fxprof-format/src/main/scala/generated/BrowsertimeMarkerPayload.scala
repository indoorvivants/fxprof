...
class BrowsertimeMarkerPayload private (
    private[fxprof] val args: BrowsertimeMarkerPayloadArgs
) {
  ...
  def `withtype`(
      value: BrowsertimeMarkerPayload_Type.type
  ...
  private def copy(
      f: BrowsertimeMarkerPayloadArgs => BrowsertimeMarkerPayloadArgs
  ) =
    new BrowsertimeMarkerPayload(f(args))

  override def equals(o: Any) = o.isInstanceOf[BrowsertimeMarkerPayload] && o
    .asInstanceOf[BrowsertimeMarkerPayload]
    .args
    .equals(this.args)
...
object BrowsertimeMarkerPayload {
  ...
  def apply(
    ...
    new BrowsertimeMarkerPayload(
      BrowsertimeMarkerPayloadArgs(
        `type` = `type`,
  ...
  implicit val codec: JsonValueCodec[BrowsertimeMarkerPayload] =
    new JsonValueCodec[BrowsertimeMarkerPayload] {
      def decodeValue(in: JsonReader, default: BrowsertimeMarkerPayload) =
        new BrowsertimeMarkerPayload(
          implicitly[JsonValueCodec[BrowsertimeMarkerPayloadArgs]]
