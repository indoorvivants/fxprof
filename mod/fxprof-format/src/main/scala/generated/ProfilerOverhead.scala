...
/** Information about profiler overhead. It includes overhead timings for
  ...
  */
class ProfilerOverhead private (
    private[fxprof] val args: ProfilerOverheadArgs
) {
  ...
  override def equals(o: Any) = o.isInstanceOf[ProfilerOverhead] && o
    .asInstanceOf[ProfilerOverhead]
    .args
    .equals(this.args)
...
object ProfilerOverhead {
  ...
  def apply(
    ...
    new ProfilerOverhead(
      ProfilerOverheadArgs(
        samples = samples,
        statistics = None,
        pid = pid,
  ...
  implicit val codec: JsonValueCodec[ProfilerOverhead] =
    new JsonValueCodec[ProfilerOverhead] {
      def decodeValue(in: JsonReader, default: ProfilerOverhead) =
        new ProfilerOverhead(
          implicitly[JsonValueCodec[ProfilerOverheadArgs]]
