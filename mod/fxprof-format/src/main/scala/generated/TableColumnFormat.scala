...
class TableColumnFormat private (
    private[fxprof] val args: TableColumnFormatArgs
) {
  ...
  override def equals(o: Any) = o.isInstanceOf[TableColumnFormat] && o
    .asInstanceOf[TableColumnFormat]
    .args
    .equals(this.args)
  ...
  implicit val codec: JsonValueCodec[TableColumnFormat] =
    new JsonValueCodec[TableColumnFormat] {
      def decodeValue(in: JsonReader, default: TableColumnFormat) =
        new TableColumnFormat(
          implicitly[JsonValueCodec[TableColumnFormatArgs]]
