...
class MarkerSchemaField private (
    private[fxprof] val args: MarkerSchemaFieldArgs
) {
  ...
  /** An optional user-facing label. If no label is provided, the key is
    * displayed instead.
    */
  def label: Option[String] = args.label

  /** The format / type of this field. This affects how the field's value is
    * displayed and determines which types of values are accepted for this
    * field.
    */
  def format: MarkerFormatType = args.format

  /** If present and set to true, this field will not be shown in the list of
    * fields in the tooltip or in the sidebar. Such fields can still be used
    * inside labels and their values are matched when searching.
    */
  ...
  override def equals(o: Any) = o.isInstanceOf[MarkerSchemaField] && o
    .asInstanceOf[MarkerSchemaField]
    .args
    .equals(this.args)
...
object MarkerSchemaField {
  ...
  /** Construct a [[MarkerSchemaField]]
    * @param keyThe
    *   property key of the marker data property that carries the field value.
    * @param formatThe
    *   format / type of this field. This affects how the field's value is
    *   displayed and determines which types of values are accepted for this
    *   field.
    */
  def apply(
    ...
    new MarkerSchemaField(
      MarkerSchemaFieldArgs(
        key = key,
        label = None,
        format = format,
        hidden = None
  ...
  implicit val codec: JsonValueCodec[MarkerSchemaField] =
    new JsonValueCodec[MarkerSchemaField] {
      def decodeValue(in: JsonReader, default: MarkerSchemaField) =
        new MarkerSchemaField(
          implicitly[JsonValueCodec[MarkerSchemaFieldArgs]]
