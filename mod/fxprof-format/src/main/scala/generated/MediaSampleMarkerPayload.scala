...
class MediaSampleMarkerPayload private (
    private[fxprof] val args: MediaSampleMarkerPayloadArgs
) {
  ...
  def `withtype`(
      value: MediaSampleMarkerPayload_Type.type
  ...
  private def copy(
      f: MediaSampleMarkerPayloadArgs => MediaSampleMarkerPayloadArgs
  ) =
    new MediaSampleMarkerPayload(f(args))

  override def equals(o: Any) = o.isInstanceOf[MediaSampleMarkerPayload] && o
    .asInstanceOf[MediaSampleMarkerPayload]
    .args
    .equals(this.args)
...
object MediaSampleMarkerPayload {
  ...
  def apply(
    ...
    new MediaSampleMarkerPayload(
      MediaSampleMarkerPayloadArgs(
        `type` = `type`,
  ...
  implicit val codec: JsonValueCodec[MediaSampleMarkerPayload] =
    new JsonValueCodec[MediaSampleMarkerPayload] {
      def decodeValue(in: JsonReader, default: MediaSampleMarkerPayload) =
        new MediaSampleMarkerPayload(
          implicitly[JsonValueCodec[MediaSampleMarkerPayloadArgs]]
