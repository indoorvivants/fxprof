...
class RawCounterSamplesTable private (
    private[fxprof] val args: RawCounterSamplesTableArgs
) {
  def time: Option[Vector[Milliseconds]] = args.time

  def timeDeltas: Option[Vector[Milliseconds]] = args.timeDeltas

  /** The number of times the Counter's "number" was changed since the previous
    * sample. This property was mandatory until the format version 42, it was
    * made optional in 43.
    */
  ...
  def withTimeDeltas(
      value: Option[Vector[Milliseconds]]
  ...
  private def copy(
      f: RawCounterSamplesTableArgs => RawCounterSamplesTableArgs
  ) =
    new RawCounterSamplesTable(f(args))

  override def equals(o: Any) = o.isInstanceOf[RawCounterSamplesTable] && o
    .asInstanceOf[RawCounterSamplesTable]
    .args
    .equals(this.args)
...
object RawCounterSamplesTable {
  ...
  def apply(
    ...
    new RawCounterSamplesTable(
      RawCounterSamplesTableArgs(
        time = None,
        timeDeltas = None,
        number = None,
        count = Vector.empty,
  ...
  implicit val codec: JsonValueCodec[RawCounterSamplesTable] =
    new JsonValueCodec[RawCounterSamplesTable] {
      def decodeValue(in: JsonReader, default: RawCounterSamplesTable) =
        new RawCounterSamplesTable(
          implicitly[JsonValueCodec[RawCounterSamplesTableArgs]]
