...
class PaintProfilerMarkerTracing private (
    private[fxprof] val args: PaintProfilerMarkerTracingArgs
) {
  ...
  def `withtype`(
      value: PaintProfilerMarkerTracing_Type.type
  ): PaintProfilerMarkerTracing =
    copy(_.copy(`type` = value))

  def withCategory(
      value: PaintProfilerMarkerTracing_Category.type
  ): PaintProfilerMarkerTracing =
  ...
  private def copy(
      f: PaintProfilerMarkerTracingArgs => PaintProfilerMarkerTracingArgs
  ) =
    new PaintProfilerMarkerTracing(f(args))

  override def equals(o: Any) = o.isInstanceOf[PaintProfilerMarkerTracing] && o
    .asInstanceOf[PaintProfilerMarkerTracing]
    .args
    .equals(this.args)
...
object PaintProfilerMarkerTracing {
  ...
  def apply(
    ...
    new PaintProfilerMarkerTracing(
      PaintProfilerMarkerTracingArgs(
        `type` = `type`,
        category = category,
        cause = None
      )
  ...
  implicit val codec: JsonValueCodec[PaintProfilerMarkerTracing] =
    new JsonValueCodec[PaintProfilerMarkerTracing] {
      def decodeValue(in: JsonReader, default: PaintProfilerMarkerTracing) =
        new PaintProfilerMarkerTracing(
          implicitly[JsonValueCodec[PaintProfilerMarkerTracingArgs]]
